...
def index():
	...
	response = make_response(render_template('index.html', title='Home', form=form, pageForm = pageForm,
						   posts=posts.items, next_url=next_url,
						   prev_url=prev_url))
	response.headers['Content-Security-Policy-Report-Only'] = "default-src 'none'; form-action 'none'; frame-ancestors 'none'; report-uri https://reportviolationstomenow.report-uri.com/r/d/csp/wizard"
	return response
...
# Edit Planner
@app.route('/edit_planner', methods=['GET'])
@login_required
def edit_planner():
	return render_template("edit_planner.html",title='Edit Planner')